...
export async function createFeedback(input: Parameters<typeof createFeedbackService>[0]) {
  const result = await createFeedbackService(input);
  revalidateDashboards();
  return result;
}

export async function createPenalty(input: Parameters<typeof createPenaltyService>[0]) {
  const result = await createPenaltyService(input);
  revalidateDashboards();
  return result;
}

export async function assignRecoveryTask(input: Parameters<typeof assignRecoveryTaskService>[0]) {
  const result = await assignRecoveryTaskService(input);
  revalidateDashboards();
  return result;
}

export async function uploadAchievement(input: Parameters<typeof uploadAchievementService>[0]) {
...
export async function approveAchievement(input: Parameters<typeof approveAchievementService>[0]) {
  const result = await approveAchievementService(input);
  revalidateDashboards();
  return { id: result.id };
}

export async function createGrantDecision(input: Parameters<typeof createGrantDecisionService>[0]) {
