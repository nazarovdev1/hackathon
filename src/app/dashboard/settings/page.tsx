...
import { Bell, Shield, Palette, Globe, Key, EyeOff } from "lucide-react";
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between rounded-lg border border-border/40 bg-secondary/10 p-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Yorug' yoki qorong'u rejim</p>
                </div>
                <ThemeToggle />
              </div>
            </CardContent>
        ...
        <MotionPanel delay={0.05}>
          <Card className="glass-panel">
            ...
            <CardContent className="space-y-3">
              {[
                { label: "Yangi feedback", desc: "Mentor yoki tyutor feedback berganda", defaultChecked: true },
                { label: "Jarima ogohlantirishi", desc: "Yangi jarima qo'yilganda", defaultChecked: true },
                { label: "Sertifikat tasdiqlandi", desc: "Sertifikatingiz tasdiqlanganda", defaultChecked: true },
                { label: "Recovery deadline", desc: "Vazifa muddati yaqinlashganda", defaultChecked: true },
                { label: "Reyting o'zgarishi", desc: "Reytingingiz o'zgarganda", defaultChecked: false },
              ].map((item) => (
                <label
                  key={item.label}
              ...
              <div className="rounded-lg border border-border/40 bg-secondary/10 p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Xavfsizlik uchun parolingizni muntazam yangilang</p>
                  </div>
          ...
          <Card className="glass-panel">
            ...
            <CardContent className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{session?.user?.role ?? "STUDENT"}</span>
              </div>
              <div className="flex justify-between">
