				...
				<div className='flex flex-1 flex-col items-center justify-center text-center py-4'>
					<MotionPanel>
						<div className='max-w-4xl mx-auto flex flex-col items-center'>
							...
							<h1 className='text-4xl font-bold tracking-tight text-balance sm:text-6xl lg:text-7xl bg-clip-text text-transparent bg-linear-to-b from-foreground to-foreground/70 mb-4'>
								PDP Grantlari. <br /> Kelajak Dasturchilari.
							</h1>

							<p className='max-w-2xl text-base sm:text-lg leading-7 text-muted-foreground mb-8'>
								Talabalarning GPA, davomat, amaliy loyihalar natijalari
								(hard/soft skills) va jarimalarini tahlil qilib, PDP grant
								maqomini avtomatik kuzatib boradi. Bo'lajak IT mutaxassislari
								uchun intellektual markaz.
							</p>
							...
							<div className='flex flex-col sm:flex-row items-center gap-4'>
								...
								<Link
									className={buttonVariants({
										...
										size: 'lg',
										className:
											'h-11 px-8 text-base bg-background/50 backdrop-blur-md text-emerald-600 dark:text-emerald-400 border-emerald-500/20 hover:bg-emerald-500/5',
									})}
									href='/rating'
								>
									Reytingni ko'rish
				...
				<MotionPanel delay={0.2} id='features' className='shrink-0'>
					<div className='grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4'>
						{[
							{
								icon: ShieldCheck,
								title: 'PDP Grant Tizimi',
								value: '80+ ballik chegarasi',
								desc: 'Amaliy topshiriqlar va modullar natijalariga asoslangan avtomatlashgan grant taqsimoti.',
							},
							{
								icon: LineChart,
								title: 'Hard & Soft Skills',
								value: 'Modul natijalari tahlili',
								desc: 'Kod yozish malakasi, amaliy loyihalar va davomatni dinamik tarzda kuzating.',
							},
							{
								icon: LockKeyhole,
								title: 'Ekotizim Rollari',
								value: 'Talaba, Mentor, Tyutor',
								desc: 'PDP ekotizimidagi har bir ishtirokchi uchun alohida moslashtirilgan interfeyslar.',
							},
							{
								icon: Users,
								title: 'Recovery Signallari',
								value: "O'zlashtirish nazorati",
								desc: "Dasturlashda qiynalayotgan talabalarni aniqlang va qo'shimcha mashg'ulotlarga yo'naltiring.",
							},
						].map(item => (
							<Card
								key={item.title}
								className='glass-panel group hover:bg-card/90 transition-all duration-300 hover:shadow-[0_0_30px_rgba(16,185,129,0.1)] hover:-translate-y-1 relative overflow-hidden'
							>
								<div className='absolute top-0 right-0 w-24 h-24 bg-primary/5 rounded-full blur-2xl -mr-12 -mt-12 transition-opacity group-hover:bg-primary/10' />
