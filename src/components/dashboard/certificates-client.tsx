				...
				<MotionPanel delay={0.2}>
					<Card className='glass-panel'>
						...
						<CardContent className='text-sm text-muted-foreground space-y-3'>
							<p>
								1. <strong>Faqat shaxsiy yutuqlar:</strong> Yuklanadigan hujjat
								aynan sizning nomingizga yozilgan va joriy o'quv yili davomida
								olingan bo'lishi lozim.
							</p>
							<p>
								2. <strong>Sifat va format:</strong> Hujjatlar aniq o'qiladigan
								PDF yoki tasvir (JPEG, PNG) formatida, o'lchami 5MB dan oshmagan
								holda yuklanishi kerak.
							</p>
							<p>
