	...
	return (
		<Card className='glass-panel'>
			<CardHeader>
				...
				<CardDescription>
					Har bir fan uchun qatnashuv statistikasi va batafsil ma'lumotlar
				</CardDescription>
			</CardHeader>
				...
				{subjects.map(subject => {
					...
					return (
						...
						>
							<button
								onClick={() =>
									setExpandedSubject(isExpanded ? null : subject.subject_id)
								}
							...
							>
								...
								<div className='flex items-center gap-3 shrink-0'>
									<div className='text-right hidden sm:block'>
										...
										<p className='text-xs text-muted-foreground'>
											{subject.subject_summary.attended}/
											{subject.subject_summary.total}
										</p>
									</div>
											...
											>
												...
												<div className='flex items-center gap-2'>
													{log.reason && (
														<Badge
															variant='outline'
															className='text-xs max-w-37.5 truncate'
														>
															{log.reason}
														</Badge>
													)}
